...
public class GraphicsManager {
	...
	public GraphicsManager(){
		...
		try {
			...
			this.bossDmgImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/bossDamage.png"));
	 ...
	 * @param bossDmg the bossDmg to draw
	...
	public void makeBossDmg() {
		try {
			this.bossImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/bossDamage.png"));
		} catch (IOException e) {
